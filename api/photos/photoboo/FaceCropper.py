...
class FaceCropper(object):
    ...
    def undo_fisheye(self, image):
        ...
        K = np.array([
            ...
            [0.0, 892.5460971236596, 310.37774228716734],
            [0.0, 0.0, 1.0]
        ])
        D = np.array([
            [0.09489989460265422],
        ...
        '''
        K = np.array([
            [875.0033368372867, 0.0, 349.51365013001026],
            [0.0, 877.9770931301517, 286.37686427166864],
            [0.0, 0.0, 1.0]
        ])
        D = np.array([
            [2.220972490519459],
    ...
    def rotate(self, image, angle_degrees=90):
        self.say("ROTATING IMAGE BY {} degrees".format(str(angle_degrees)))
        # modified from:
